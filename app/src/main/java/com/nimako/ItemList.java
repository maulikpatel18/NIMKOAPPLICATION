...
public class ItemList extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener,BaseSliderView.OnSliderClickListener,ViewPagerEx.OnPageChangeListener {
    private final String TAG="ItemList";
    private RecyclerView recyclerView;
    TextView tvnotf;
    private Item_adapter adapter;
    String email,custid1,productid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_productlist);
...
//            sliderLayout.addSlider(textSliderView);
            DefaultSliderView df=new DefaultSliderView(ItemList.this);
            df.description(name).image(Hash_file_maps.get(name)).setOnSliderClickListener(new BaseSliderView.OnSliderClickListener(){
                ...
                public void onSliderClick(BaseSliderView slider) {
                    ...
                    Intent i=new Intent(ItemList.this,ItemListOffer.class);
                    i.putExtra("ee",email);
                    startActivity(i);
        ...
        adapter = new Item_adapter(ItemList.this, itemSerList);
//
        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(ItemList.this, 2);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.addItemDecoration(new ItemList.GridSpacingItemDecoration(2, dpToPx(10), true));
...
//        fm.beginTransaction().replace(R.id.contentframemain,new SubCategory_Main()).commit();
    ...
    private void prepareAlbums() {
        RequestQueue queue= Volley.newRequestQueue(ItemList.this);
        int aaa=12;

        String url="https://nimako.lbyts.com/api/products/?display=[id,name,unit_price_ratio,price,description,link_rewrite,id_default_image,on_sale,wholesale_price]&filter[id_category_default]=["+subcatename+"]&output_format=JSON";
                ...
                if(response.length()>=3) {
                        ...
                        List<Item_Ser> itemSer = new ArrayList<Item_Ser>();
                            ...
                            for (int i = 0; i < result1.getProducts().size(); i++) {
                                ...
                                itemSer.add(result1);
                                adapter = new Item_adapter(ItemList.this, itemSer);
...
//        }));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.cart_item) {
            Intent i=new Intent(ItemList.this,Cart_main.class);
            startActivity(i);
            return true;
        }
...
//    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent i=new Intent(ItemList.this,Navigation.class);
            i.putExtra("ee",email+"");
            startActivity(i);
...
//            logoutUser();
            ...
            Intent i=new Intent(ItemList.this,YourAc.class);
            i.putExtra("ee",email+"");
            startActivity(i);
        }else if (id == R.id.nav_wishlist) {
            Intent i=new Intent(ItemList.this,Wishlist_main.class);
            i.putExtra("ee",email+"");
            startActivity(i);

        } else if(id==R.id.nav_Customerservice)
        {
            Intent i=new Intent(ItemList.this,CustomerService.class);
            i.putExtra("ee",email+"");
            startActivity(i);
            ...
            Intent i=new Intent(ItemList.this,Order_main.class);
            i.putExtra("ee",email+"");
            startActivity(i);
        }
